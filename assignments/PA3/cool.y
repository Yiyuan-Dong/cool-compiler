...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    partial_let : IN expression
        {
            $$ = $2;
        }
    | ',' OBJECTID ':' TYPEID partial_let
        {
            $$ = let($2, $4, no_expr(), $5);
        }
    | ',' OBJECTID ':' TYPEID ASSIGN expression partial_let
        {
            $$ = let($2, $4, $6, $7);
        }
    | ',' error partial_let
    ...
    | LET OBJECTID ':' TYPEID ASSIGN expression partial_let
        {
            $$ = let($2, $4, $6, $7);
        }
